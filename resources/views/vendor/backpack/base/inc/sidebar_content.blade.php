...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('invite') }}'><i class='nav-icon la la-question'></i> Invites</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('team') }}'><i class='nav-icon la la-question'></i> Teams</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('teamxlsform') }}'><i class='nav-icon la la-question'></i> Team Xlsform</a></li>
